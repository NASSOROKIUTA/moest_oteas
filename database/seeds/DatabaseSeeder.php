...
use App\User;
use App\Model\SetupData\Tbl_department;
use App\Model\SetupData\Tbl_country;
use App\Model\SetupData\Tbl_country_zone;
use App\Model\SetupData\Tbl_marital;
use App\Model\SetupData\Tbl_proffesional;
...
use App\Model\SetupData\Tbl_permission;
use App\Model\SetupData\Tbl_glyphicon;
...
$teaching_subjects= array(
  ...
  $periods_per_weeks= array(
   ...
   ['number_of_periods' => 30,'class_grade_id' =>2,'subject_id' =>null],
     //STD 2
   ['number_of_periods' => 30,'class_grade_id' =>3,'subject_id' =>null],
    //STD 3
   ['number_of_periods' => 31,'class_grade_id' =>4,'subject_id' =>null],  
  //STD 4
   ['number_of_periods' => 31,'class_grade_id' =>5,'subject_id' =>null],   
  //STD 5
   ['number_of_periods' => 40,'class_grade_id' =>6,'subject_id' =>null], 
  //STD 6
   ['number_of_periods' => 40,'class_grade_id' =>7,'subject_id' =>null],    
  //STD 7
   ['number_of_periods' => 40,'class_grade_id' =>8,'subject_id' =>null],    
