...
class systemViews{
	...
	public static function createPermits(){

		$sql="CREATE OR REPLACE VIEW  vw_permits AS(SELECT  t4.id AS department_id, t1.council_id,(SELECT t1.permits FROM tbl_permits t1 WHERE  t1.gender = 'F' AND  t1.council_id=t3.id  GROUP BY t1.gender)  AS female
